...
> פרוקסי מאובטח: פרוקסי רשת עם בדיקת חבילות, לוגים ומדיניות גישה
...
##  Architecture
Three-tier architecture: Go, gRPC backend, native frontend, PostgreSQL database. Containerized with Docker.
...
git clone https://github.com/elitsuri/פרוקסי-מאובטח
cd פרוקסי-מאובטח
