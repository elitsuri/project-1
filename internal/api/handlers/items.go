...
import (
	...
	"github.com/example/פרוקסי-מאובטח/internal/api/middleware"
	"github.com/example/פרוקסי-מאובטח/internal/domain"
	"github.com/example/פרוקסי-מאובטח/internal/service"
	"github.com/example/פרוקסי-מאובטח/pkg/response"
)
